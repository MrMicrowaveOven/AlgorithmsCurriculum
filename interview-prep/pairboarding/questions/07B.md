**Given an array, move all zeros to the end. The order of non-zero elements does not matter. Algorithm should be O(n) Ex: move_zeros([1,2,0,3,4,0,5,6,0]) == [1,2,6,3,4,5,0,0,0]**
