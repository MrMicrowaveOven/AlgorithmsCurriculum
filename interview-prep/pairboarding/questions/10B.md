**Write a function that takes an integer and returns the occurence of 1s in its binary form, without the intermediate step of finding the actual binary form.**
